...
public class DynamicWorkloadActivity extends TestOutputActivityBase {
    ...
    private static final String TAG = "CPULoad";
    ...
    private boolean mShouldUseWorkloadReporting = true;
    ...
    public void stopTest(View view) {
        ...
        // grantliu: print the number of "cpu load xruns"
        Log.d(TAG, "cpu load xruns = " + outputStream.getXRunCount());
        onStopTest();
    }
